function carregaHeaderFooter() {
    const URL = "http://localhost:8080/apis/adm/get-parametrizacao";
    const token = localStorage.getItem('jwtToken');
    const tag = document.getElementById("headerAdm");
    const tag2 = document.getElementById("footerAdm");
    ...
    .then(json => {
        ...
        let headerContent = `<div class="logo">
                            ...
                            <nav class="main-nav">
                                <ul>
                                    <li><a href="paginaAdmin.html">Home</a></li>
                                    <li><a href="#">Cursos</a></li>
                                    <li class="has-submenu"><a href="#">Usuários</a>
                                        <ul class="submenu">
                                            <li><a href="deletarAcesso.html">Desativar</a></li>
                                        </ul>
                                    </li>
                                    <li><a href="#">Realizar doação</a></li>
                                    <li class="has-submenu"><a href="#">Parametrização</a>
                                        <ul class="submenu">
                                            <li><a href="alterarParametrizacao.html">Alterar dados</a></li>
                                        </ul>
                                    </li>
                                    <li></li><li></li><li></li>
                                    <li><a href="index.html" style="color:red;">Sair</a></li>
                                </ul>
                            </nav>
